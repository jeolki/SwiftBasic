...
/*
  - 자판기 동작 요류의 종류를 표현한 VendingMachineError 열거형
*/
...
} catch /*(let error)*/ { // catch 구문으로 자동으로 넘어온다.
...
/*
  2. try!
    - 오류가 발생하지 않을 것이라는 강력한 확신을 가질 대 try!를 사용하면 정상동작 후에 바로 결과값을 돌려받습니다.
